...
const latlong.LatLng _coordenadasIFRNCNAT = latlong.LatLng(-5.811929, -35.204526);
const String _nomeCampus = "IFRN - Campus Natal - Central";
const String _googleMapsUrlIFRNCNAT = "https://maps.app.goo.gl/pDcWhewtAGqaFzob6"; // Ajuste a URL com as coordenadas corretas


class MapaIFRNCNATPage extends StatefulWidget {
  const MapaIFRNCNATPage({super.key});

  @override
  State<MapaIFRNCNATPage> createState() => _MapaIFRNCNATPageState();
}

class _MapaIFRNCNATPageState extends State<MapaIFRNCNATPage> {
              ...
              child: Padding(
                ...
                child: ClipRRect( // Para dar bordas arredondadas ao mapa se desejar
                  ...
                  child: FlutterMap(
                    ...
                    options: MapOptions(
                      initialCenter: _coordenadasIFRNCNAT,
